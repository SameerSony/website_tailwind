                ...
                <div className="flex flex-col items-center justify-center min-h-screen py-8 bg-black">
                  <div className="flex flex-col items-center gap-8 w-full px-4 md:px-8 lg:px-16">
                    <div className="bg-black p-6 rounded-lg shadow-lg w-full h-full">
                      ...
                      <div className="px-4 mt-8 md:mt-32 mb-32">
                        <button
                          ref={buttonRef}
                          onMouseEnter={handleMouseEnter}
                          onMouseLeave={handleMouseLeave}
                          type='button'
                          className='w-32 h-32 md:w-40 md:h-40 mx-auto md:ml-80 justify-center border border-gray-500 rounded-full shadow-xs bg-transparent font-semibold text-white transition-transform duration-300 hover:bg-white hover:text-black items-center text-lg md:text-xl'>
                          Contact Us
                        </button>
                      </div>
                    </div>
